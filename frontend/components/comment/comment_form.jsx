...
export default class SessionForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props
      .postComment(comment, this.props.trackId)
        ...
        <div className="commentForm commentForm__transition m-large visible">
          <div className="commentForm__wrapper commentForm__transition">
            <div className="commentForm__avatar">
              <img
                src={this.props.currentArtist.image_url}
                className="comment_av sc-artwork sc-artwork-placeholder-1"
              />
            </div>
            <div className="commentForm__inputWrapper sc-border-box">
              <input
                type="text"
                className="commentForm__input sc-border-box"
                value={this.state.body}
                placeholder="Write a comment"
                onChange={this.handleInput("body")}
              />
              <button className="comment__post" type="submit">
