        ...
        return (
            ...
            <div className="frontHero__container">
                ...
                <div className="frontHero__content">
                    ...
                    <p className="frontHero__tagline sc-type-large">Discover, stream, and share a constantly expanding mix of music from emerging and major artists around the world.</p>
                    <div className="frontHero__cta">
                    <button className="g-opacity-transition frontHero__ctaButton sc-button sc-button-cta sc-button sc-button-medium signupButton" onClick={() => openModal('signup')}>
                        Sign up for free
                    </button>
                    </div>
                </div>
