...
export default ({ currentArtist, logout }) => {
  ...
  const display = (
    <header
      role="banner"
      className="header sc-selection-disabled fixed g-dark g-z-index-header show"
    >
        ...
        <div className="header__left">
          <div className="header__logo left">
            <Link
              to="/"
              title="Home"
              className="header__logoLink sc-border-box sc-ir"
            >
              SoundLoud
            </Link>
          </div>
          <nav className="left header__navWrapper" role="navigation">
            <ul className="header__navMenu header__mainMenu left sc-list-nostyle">
              <li>
                <Link
                  className="header__mainMenu-loggedInHome header__mainMenu-stream"
                  to="/"
                >
                  Home
                </Link>
        ...
        <div className="header__right sc-clearfix">
          ...
          <div className="image userNav__item userNav__avatar m-user image__lightOutline readOnly customImage sc-artwork sc-artwork-placeholder-1 image__rounded m-loaded">
            <Link
              ...
              className="userNav__button userNav__usernameButton"
            >
              <img
                className="header_nav_pic sc-artwork sc-artwork-placeholder-1 image__rounded image__full g-opacity-transition"
            ...
            <div className="userNav sc-clearfix">
              ...
              >
                <div className="userNav__item">
                  <div className="userNav__username sc-truncate">
                    {currentArtist.name}
                  </div>
                </div>
              </Link>
