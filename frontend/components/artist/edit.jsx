...
class Edit extends React.Component {
  ...
  formImage() {
    if (this.state.imageUrl) {
      return (
        <img
          className="upload-display image__rounded image__full"
  ...
  handleSubmit(e) {
    ...
    this.props
      .updateArtist(formData, this.props.currentArtist.id)
      .then(() => this.props.history.push(`/artists/${this.state.id}`));
  }
              ...
              <div className="sc-media">
                ...
                <div className="profileSettings__baseFields sc-media-content">
                  <div className="profileSettings__cell m-fullWidth">
                    <label className="textfield__label">Upload Photo:</label>
                  </div>
                  <input type="file" onChange={this.updateFile} />
                  <div className="profileSettings__cell m-fullWidth">
                    <div className="textfield profileSettings__description">
                      <label className="textfield__label">Bio</label>
