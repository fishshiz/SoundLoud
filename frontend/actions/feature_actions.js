import {
  fetchFeaturedTracks,
  fetchDiscussedTracks
} from "../util/feature_api_util";
...
export const requestFeaturedTracks = () => dispatch =>
  fetchFeaturedTracks().then(payload => dispatch(receiveMainTracks(payload)));

export const requestCommentedTracks = () => dispatch =>
  fetchDiscussedTracks().then(payload => dispatch(receiveMainTracks(payload)));
